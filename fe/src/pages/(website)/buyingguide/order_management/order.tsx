    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <main className="flex-1 p-8">
        ...
        <div className="mt-6">
         ...
         {/* Section 2: Chi tiết đơn hàng */}
         <div className="bg-grey  rounded-lg p-3">
          {/* Added "Ví dụ" section */}
          <div className="bg-gray-100 p-4 rounded-md mb-6">
            <h3 className="text-lg font-bold mb-2">Ví dụ:</h3>
            <p className="mb-3">
              Bạn muốn biết tháng <strong>03/2020</strong> bạn đã phát sinh bao nhiêu tiền trên Shop.
              Chỉ cần tìm kiếm đơn hàng với điều kiện:
            </p>
            <ul className="list-disc ml-6">
              <li>Ngày tạo từ: <strong>2020-03-01</strong></li>
              <li>Ngày tạo đến: <strong>2020-03-31</strong></li>
            </ul>
            <p className="mt-2">
              Sau đó bấm <strong>Tìm kiếm</strong>, khi có kết quả, Tổng tiền hiện ra chính là tổng
              tiền phát sinh trong tháng <strong>03/2020</strong>.
            </p>
          </div>
