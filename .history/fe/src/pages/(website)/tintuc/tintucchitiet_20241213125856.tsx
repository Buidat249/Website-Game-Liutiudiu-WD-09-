                    ...
                    {description.map((desc) => (
                      ...
                      >
                        ...
                        {Array.isArray(desc.descriptiondetail_id) &&
                          desc.descriptiondetail_id.length > 0 && (
                            <div className="mt-4">
                              {descriptionDetail &&
                                  ...
                                  <ul className="space-y-4">
                                    {descriptionDetail
                                      .filter(
                                        (detail) =>
                                          Array.isArray(
                                            desc.descriptiondetail_id
                                          ) &&
                                          desc.descriptiondetail_id.includes(
                                            detail.descriptiondetail_id
                                          )
                                      )
                                      .map((detail) => (
                                        <li
                                          key={detail.descriptiondetail_id}
