...
const Orders = () => {
  ...
  const [selectedOrder, setSelectedOrder] = useState<any | null>(null); // Trạng thái lưu đơn hàng chi tiết
  ...
  const handleViewDetails = (order: any) => {
    setSelectedOrder(order); // Lưu đơn hàng chi tiết vào state
  };
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md max-w-4xl w-[800px] my-6 mx-auto">
      ...
      {selectedOrder && (
        <div className="mt-6">
          <h3 className="text-xl font-semibold mb-4">Chi tiết đơn hàng {selectedOrder.order_id}</h3>
